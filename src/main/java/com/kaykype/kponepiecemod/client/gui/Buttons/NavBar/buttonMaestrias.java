...
public class buttonMaestrias extends Button{
    ...
    public buttonMaestrias(int x, int y, int width, int height, String text, Button.IPressable onPress) {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks){
        ...
        fontRenderer.drawShadow(matrixStack, "Maestrias", (x-(mc.font.width("Maestrias")/2))+(width/2), (y+(height/2))-(mc.font.lineHeight/2), textColor);
    }
}
