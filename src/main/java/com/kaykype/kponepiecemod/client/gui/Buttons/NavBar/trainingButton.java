...
public class trainingButton extends Button {
    ...
    public trainingButton (int x, int y, int width, int height, String text, Button.IPressable onPress) {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks){
        ...
        fontRenderer.drawShadow(matrixStack, "Treinos", (x-(mc.font.width("Treinos")/2))+(width/2), (y+(height/2))-(mc.font.lineHeight/2), textColor);
    }
}
