...
public class previousButton extends Button {
    ...
    public previousButton (int x, int y, int width, int height, String text, Button.IPressable onPress) {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks){
        ...
        fontRenderer.drawShadow(matrixStack, "<", (x-(fontRenderer.width(">")/2)), (y-(fontRenderer.lineHeight/2))+(height/2), textColor);
    }
}
