...
public class doneButton extends Button {
    ...
    public doneButton(int x, int y, int width, int height, String text, Button.IPressable onPress) {
    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        ...
        fontRenderer.drawShadow(matrixStack, "Pronto", (x-(mc.font.width("Pronto")/2))+(width/2), (y+(height/2))-(mc.font.lineHeight/2), textColor);
    }
}
